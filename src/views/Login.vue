<template>
  <v-app id="inspire">
    <div class="signup-buttons mt-15 mx-auto text-center">
      <h1>OrgContacts</h1>

      <p>Aplicativo agenda de contatos</p>
      ...
      this.$gAuth
        ...
        .then(GoogleUser => {
          ...
          var userInfo = {
            ...
            tokenExpiresAt: GoogleUser.uc.expires_at,
            idToken: GoogleUser.uc.id_token,
            username: GoogleUser.Es.sd,
            email: GoogleUser.Es.kt,
            givenName: GoogleUser.Es.nT,
            familyName: GoogleUser.Es.pR,
